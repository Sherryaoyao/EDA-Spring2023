...
> Answer: I took ENV 710 last semester which used R to conduct linear regressions and tested related assumptions. 

2. Are there any components of the course about which you feel confident?

> Answer: I am confident to use R interface in general and conduct data visualization.

3. Are there any components of the course about which you feel apprehensive?

> Answer: I am not that familiar with data scraping and the times series part, although it might be easier than I thought once we started to learn.
...
> Answer: https://github.com/Sherryaoyao/EDA-Spring2023.git
